...
4. Download [CARLA 0.9.6](https://github.com/carla-simulator/carla/releases/tag/0.9.6) Extract it to some folder, and add CARLA to ```PYTHONPATH``` environment variable:
```
